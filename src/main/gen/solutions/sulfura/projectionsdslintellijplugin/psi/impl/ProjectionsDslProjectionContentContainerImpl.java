...
public class ProjectionsDslProjectionContentContainerImpl extends ASTWrapperPsiElement implements ProjectionsDslProjectionContentContainer {

  public ProjectionsDslProjectionContentContainerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProjectionsDslVisitor visitor) {
    visitor.visitProjectionContentContainer(this);
  }
